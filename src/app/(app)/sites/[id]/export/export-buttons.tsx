...
export function ExportButtons({ siteId, siteName }: { siteId: string; siteName: string }) {
  ...
  function handleMarkdownExport() {
    ...
    let markdown = `# NSGP Application — ${siteName}\n\n`
    ...
    a.href = url
    a.download = `${siteName.replace(/\s+/g, '-')}-NSGP-Application.md`
    a.click()
