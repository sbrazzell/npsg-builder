...
export default async function BudgetPage({
  ...
  const totalBudget = project.budgetItems.reduce((s, b) => s + b.totalCost, 0)
  ...
  return (
    <div>
      <Header breadcrumbs={[
        ...
        { label: project.facility.facilityName, href: `/facilities/${id}` },
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <table className="w-full text-sm">
                      ...
                      <tbody>
                        {project.budgetItems.map((item) => (
                          <BudgetItemRow key={item.id} item={item} facilityId={id} projectId={projectId} />
                        ))}
                      </tbody>
                      <tfoot>
          ...
          <div>
            <Card>
              ...
              <CardContent>
                <BudgetItemForm projectId={projectId} facilityId={id} />
              </CardContent>
            </Card>
          </div>
        </div>
