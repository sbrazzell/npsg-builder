...
async function getFacilityWithAnalysis(siteId: string) {
    ...
    <div>
      ...
      <div className="p-4 md:p-8 max-w-5xl mx-auto">
        <PageHeader
          ...
          description={`${facility.siteName} · ${facility.organization.name}`}
          action={<RunAnalysisButton siteId={siteId} />}
        />
        ...
        <SectionReadinessPanel siteId={siteId} />

        {/* Narrative Improvement Suggestions */}
        <NarrativeImprovementsPanel siteId={siteId} />
      </div>
    </div>
  )
}
