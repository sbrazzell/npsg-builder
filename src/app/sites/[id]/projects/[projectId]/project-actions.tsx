...
export function ProjectActions({ project, siteId }: { project: any; siteId: string }) {
  ...
  async function handleDelete() {
    ...
    setDeleting(true)
    const result = await deleteProject(project.id, siteId)
    if (result.success) {
      toast.success('Project deleted')
      router.push(`/sites/${siteId}/projects`)
    } else {
