    ...
    <div>
      ...
      <div className="p-4 md:p-8">
        <PageHeader
          ...
          description={`Application readiness assessment for ${facility.siteName}`}
          action={
            <Button asChild variant="outline" size="sm">
              <Link href={`/sites/${id}/export`}>
        ...
        {overallPct >= 75 && (
          <Alert className="mt-6 border-green-200 bg-green-50">
            ...
            <AlertDescription className="text-green-800">
              This application is in good shape. Review any remaining warnings, then proceed to <Link href={`/sites/${id}/export`} className="font-medium underline">Export</Link> to download your draft application packet.
            </AlertDescription>
          </Alert>
        )}
      </div>
