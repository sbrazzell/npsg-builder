...
const FIELD_GUIDANCE: Record<string, string> = {
  'Population Served': 'Write 1-2 concise sentences describing the demographic makeup and size of the population this facility serves. Include types of people (families, youth, elderly, congregation size, etc.).',
  'Days / Hours of Operation': 'Write a concise 1-sentence summary of when this facility is typically open and active.',
  'Occupancy Notes': 'Write 1-2 sentences describing how the facility is occupied — peak times, gatherings, events, typical attendance numbers.',
  'Children\'s Areas': 'Write 1-2 sentences describing the children\'s spaces in the facility — nurseries, classrooms, playgrounds — and why they warrant special protection.',
  ...
  'Public Access': 'Write 1-2 sentences describing how the public can access this facility — open to all vs. restricted, entry points, visitor management.',
  'Known Security Concerns': 'Write 2-3 sentences describing the most significant known security vulnerabilities or concerns at this facility. Be specific and actionable.',
  ...
  'Description': 'Write 2-3 sentences describing how this specific threat type manifests at or near this type of facility. Be concrete and specific.',
  'Why is this facility vulnerable?': 'Write 2-3 sentences explaining the specific physical, operational, or situational conditions that make this facility vulnerable to this threat. This feeds directly into the grant narrative.',
